...
source: "https://warmwater.dev/blog/claude-code-commands-beginner"
site: "warmwater.dev"
author:
  - "溫煜鈞"
...
> **出處：** [warmwater.dev](https://warmwater.dev/blog/claude-code-commands-beginner) | 溫煜鈞 | 2026-05-14
...
2026-05-14 · 154 views

![\"\"](\"/images/claude-code-commands-beginner/cover.png\")
...
![\"rewind](\"/images/claude-code-commands-beginner/rewind.png\")
...
![\"resume](\"/images/claude-code-commands-beginner/resume.png\")
...
![\"plan](\"/images/claude-code-commands-beginner/plan-mode.png\")
...
\*\*什麼時候用：\*\*任務超過 3 個步驟、會動到多個檔案、或者不確定 Claude Code 會怎麼做，先跑 Plan Mode。比起事後 undo，事前確認更省時間。
...
![\"輸入](\"/images/claude-code-commands-beginner/superpowers-brainstorming.png\")
...
![\"自然語言](\"/images/claude-code-commands-beginner/subagent-trigger.png\")
...
![\"4](\"/images/claude-code-commands-beginner/subagent-running.png\")
...
> \\n
> 
> **結語**：這三層操作有一個共同的邏輯——讓 Claude Code 知道你在做什麼、你想怎麼做、你不想要什麼。說得越清楚，它就越有用。
> 
> \\n
...
- [第一層：用 @file、# 和 ! 讓 Claude Code 準確理解你的意圖](\"#第一層用-file-和--讓-claude-code-準確理解你的意圖\")
- [1\. @file：告訴 Claude Code 只看這裡](\"#1-file告訴-claude-code-只看這裡\")
- [2\. #：留便條，補充 context](\"#2-留便條補充-context\")
- [3\. !：在對話框直接執行 shell 指令](\"#3-在對話框直接執行-shell-指令\")
- [第二層：用 ESC、/clear、/rewind、/resume 控制對話節奏](\"#第二層用-escclearrewindresume-控制對話節奏\")
- [4\. ESC：打斷輸出](\"#4-esc打斷輸出\")
- [5\. /clear：清空 session，重新開始](\"#5-clear清空-session重新開始\")
- [6\. /compact：壓縮 context，不中斷工作](\"#6-compact壓縮-context不中斷工作\")
- [7\. /rewind：倒帶回任意時間點](\"#7-rewind倒帶回任意時間點\")
- [8\. /resume：接回上次的工作](\"#8-resume接回上次的工作\")
- [9\. /cost：確認 token 用量](\"#9-cost確認-token-用量\")
- [第三層：用 /init、Plan Mode 與 Superpowers 解鎖進階工作方式](\"#第三層用-initplan-mode-與-superpowers-解鎖進階工作方式\")
- [10\. /init：建立 CLAUDE.md，讓規則永久生效](\"#10-init建立-claudemd讓規則永久生效\")
- [11\. Plan Mode：先規劃，再動手](\"#11-plan-mode先規劃再動手\")
- [12\. 安裝 Superpowers：讓 Claude Code 有更多能力](\"#12-安裝-superpowers讓-claude-code-有更多能力\")
- [13\. Subagent：讓 Claude Code 平行處理多件事](\"#13-subagent讓-claude-code-平行處理多件事\")
- [快速參考](\"#快速參考\")
