...
首次运行后会先让您选择环境，请注意，AitoEarn有两个环境，分别是中国版和国际版环境。 如果使用中国版环境+国际版的key会导致401报错。 请确保环境与key是匹配的。

安装完成后，你就可以在 OpenClaw 中直接接收并执行 AiToEarn 的赚钱任务：

[![在 OpenClaw 中执行 AiToEarn 赚钱任务](https://github.com/yikart/AiToEarn/raw/main/presentation/openclaw-earn-demo.png)](https://github.com/yikart/AiToEarn/blob/main/presentation/openclaw-earn-demo.png)
