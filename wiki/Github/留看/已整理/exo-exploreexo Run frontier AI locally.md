---
title: "exo-explore/exo: Run frontier AI locally."
source: "https://github.com/exo-explore/exo"
author:
published:
created: 2026-05-14
description: "Run frontier AI locally. Contribute to exo-explore/exo development by creating an account on GitHub."
tags:
  - "clippings"
---
![exo logo](https://github.com/exo-explore/exo/raw/main/docs/imgs/exo-logo-black-bg.jpg)
...
[![exo dashboard - cluster view showing 4 x M3 Ultra Mac Studio with DeepSeek v3.1 and Kimi-K2-Thinking loaded](https://github.com/exo-explore/exo/raw/main/docs/imgs/dashboard-cluster-view.png)](https://github.com/exo-explore/exo/blob/main/docs/imgs/dashboard-cluster-view.png)

*4 × 512GB M3 Ultra Mac Studio running DeepSeek v3.1 (8-bit) and Kimi-K2-Thinking (4-bit)*

## Benchmarks

Qwen3-235B (8-bit) on 4 × M3 Ultra Mac Studio with Tensor Parallel RDMA [![Benchmark - Qwen3-235B (8-bit) on 4 × M3 Ultra Mac Studio with Tensor Parallel RDMA](https://github.com/exo-explore/exo/raw/main/docs/benchmarks/jeffgeerling/mac-studio-cluster-ai-full-1-qwen3-235b.jpeg)](https://github.com/exo-explore/exo/blob/main/docs/benchmarks/jeffgeerling/mac-studio-cluster-ai-full-1-qwen3-235b.jpeg)
...
DeepSeek v3.1 671B (8-bit) on 4 × M3 Ultra Mac Studio with Tensor Parallel RDMA [![Benchmark - DeepSeek v3.1 671B (8-bit) on 4 × M3 Ultra Mac Studio with Tensor Parallel RDMA](https://github.com/exo-explore/exo/raw/main/docs/benchmarks/jeffgeerling/mac-studio-cluster-ai-full-2-deepseek-3.1-671b.jpeg)](https://github.com/exo-explore/exo/blob/main/docs/benchmarks/jeffgeerling/mac-studio-cluster-ai-full-2-deepseek-3.1-671b.jpeg)

**Source:** [Jeff Geerling: 15 TB VRAM on Mac Studio – RDMA over Thunderbolt 5](https://www.jeffgeerling.com/blog/2025/15-tb-vram-on-mac-studio-rdma-over-thunderbolt-5)

Kimi K2 Thinking (native 4-bit) on 4 × M3 Ultra Mac Studio with Tensor Parallel RDMA [![Benchmark - Kimi K2 Thinking (native 4-bit) on 4 × M3 Ultra Mac Studio with Tensor Parallel RDMA](https://github.com/exo-explore/exo/raw/main/docs/benchmarks/jeffgeerling/mac-studio-cluster-ai-full-3-kimi-k2-thinking.jpeg)](https://github.com/exo-explore/exo/blob/main/docs/benchmarks/jeffgeerling/mac-studio-cluster-ai-full-3-kimi-k2-thinking.jpeg)
...
This starts the exo dashboard and API at [http://localhost:52415/](http://localhost:52415/)
...
[![exo macOS App - running on a MacBook](https://github.com/exo-explore/exo/raw/main/docs/imgs/macos-app-one-macbook.png)](https://github.com/exo-explore/exo/blob/main/docs/imgs/macos-app-one-macbook.png)
...
| `EXO_FAST_SYNCH` | Control MLX\_METAL\_FAST\_SYNCH behavior (for JACCL backend) | Auto |
...
- API documentation in [docs/api.md](https://github.com/exo-explore/exo/blob/main/docs/api.md).
- API types and endpoints in [src/exo/master/api.py](https://github.com/exo-explore/exo/blob/main/src/exo/master/api.py).
...
The tool outputs performance metrics including prompt tokens per second (prompt\_tps), generation tokens per second (generation\_tps), and peak memory usage for each configuration.
