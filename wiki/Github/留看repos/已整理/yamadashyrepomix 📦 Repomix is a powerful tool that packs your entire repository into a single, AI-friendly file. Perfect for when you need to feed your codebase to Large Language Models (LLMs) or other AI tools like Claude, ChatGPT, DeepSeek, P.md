---
title: "yamadashy/repomix: 📦 Repomix is a powerful tool that packs your entire repository into a single, AI-friendly file. Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools like Claude, ChatGPT, DeepSeek, Perplexity, Gemini, Gemma, Llama, Grok, and more."
source: "https://github.com/yamadashy/repomix"
author:
published:
created: 2026-05-14
description: "📦 Repomix is a powerful tool that packs your entire repository into a single, AI-friendly file. Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools like Claude, ChatGPT, DeepSeek, Perplexity, Gemini, Gemma, Llama, Grok, and more. - yamadashy/repomix"
tags:
  - "clippings"
---
<sup>Special thanks to:</sup>  
  
[![Warp sponsorship](https://raw.githubusercontent.com/warpdotdev/brand-assets/main/Github/Sponsor/Warp-Github-LG-01.png)](https://go.warp.dev/repomix)
...
[![Repomix](https://github.com/yamadashy/repomix/raw/main/website/client/src/public/images/repomix-title.png)](https://repomix.com/)
...
[![Sponsors](https://camo.githubusercontent.com/62cafdce9b9fa407ac266b42242882dc4901750421028875a35d32919d86f04f/68747470733a2f2f63646e2e6a7364656c6976722e6e65742f67682f79616d6164617368792f73706f6e736f722d6c6973742f73706f6e736f72732f73706f6e736f72732e706e67)](https://github.com/sponsors/yamadashy)
...
[![Repomix File Usage 1](https://github.com/yamadashy/repomix/raw/main/website/client/src/public/images/docs/repomix-file-usage-1.png)](https://github.com/yamadashy/repomix/blob/main/website/client/src/public/images/docs/repomix-file-usage-1.png)
...
[![Repomix File Usage 2](https://github.com/yamadashy/repomix/raw/main/website/client/src/public/images/docs/repomix-file-usage-2.png)](https://github.com/yamadashy/repomix/blob/main/website/client/src/public/images/docs/repomix-file-usage-2.png)
...
[![Repomix Browser Extension](https://github.com/yamadashy/repomix/raw/main/website/client/src/public/images/docs/browser-extension.png)](https://github.com/yamadashy/repomix/blob/main/website/client/src/public/images/docs/browser-extension.png)
...
- `--token-count-encoding <encoding>`: Tokenizer model for counting: o200k\_base (GPT-4o), cl100k\_base (GPT-3.5/4), etc. (default: o200k\_base)
...
1. **pack\_codebase**: Package a local code directory into a consolidated XML file for AI analysis
- Parameters:
	- `directory`: Absolute path to the directory to pack
		- `compress`: (Optional, default: false) Enable Tree-sitter compression to extract essential code signatures and structure while removing implementation details. Reduces token usage by ~70% while preserving semantic meaning. Generally not needed since grep\_repomix\_output allows incremental content retrieval. Use only when you specifically need the entire codebase content for large repositories.
		...
		- `ignorePatterns`: (Optional) Specify additional files to exclude using fast-glob patterns. Multiple patterns can be comma-separated (e.g., "test/**,\*.spec.js", "node\_modules/**,dist/\*\*"). These patterns supplement.gitignore,.ignore, and built-in exclusions.
...
2. **attach\_packed\_output**: Attach an existing Repomix packed output file for AI analysis
- Parameters:
...
- Features:
	- Accepts either a directory containing a repomix-output.xml file or a direct path to an XML file
		- Registers the file with the MCP server and returns the same structure as the pack\_codebase tool
...
3. **pack\_remote\_repository**: Fetch, clone, and package a GitHub repository into a consolidated XML file for AI analysis
- Parameters:
	- `remote`: GitHub repository URL or user/repo format (e.g., "yamadashy/repomix", " [https://github.com/user/repo](https://github.com/user/repo) ", or " [https://github.com/user/repo/tree/branch](https://github.com/user/repo/tree/branch) ")
		...
		- `ignorePatterns`: (Optional) Specify additional files to exclude using fast-glob patterns. Multiple patterns can be comma-separated (e.g., "test/**,\*.spec.js", "node\_modules/**,dist/\*\*"). These patterns supplement.gitignore,.ignore, and built-in exclusions.
		- `topFilesLength`: (Optional, default: 10) Number of largest files by size to display in the metrics summary for codebase analysis.
4. **read\_repomix\_output**: Read the contents of a Repomix-generated output file. Supports partial reading with line range specification for large files.
- Parameters:
...
5. **grep\_repomix\_output**: Search for patterns in a Repomix output file using grep-like functionality with JavaScript RegExp syntax
- Parameters:
...
6. **file\_system\_read\_file**: Read a file from the local file system using an absolute path. Includes built-in security validation to detect and prevent access to files containing sensitive information.
- Parameters:
...
7. **file\_system\_read\_directory**: List the contents of a directory using an absolute path. Returns a formatted list showing files and subdirectories with clear indicators.
- Parameters:
...
[![contributors](https://camo.githubusercontent.com/af3c02236ef4d876f5b1ed71b4f4c74b6bdf8cc667adce350eb409a007a51db0/68747470733a2f2f636f6e747269622e726f636b732f696d6167653f7265706f3d79616d6164617368792f7265706f6d6978)](https://github.com/yamadashy/repomix/graphs/contributors)
...
[Back To Top](#repo-content-pjax-container)