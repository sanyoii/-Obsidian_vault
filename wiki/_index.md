...
- [[Quant-Trading/投行金流與反洗錢-自學教材|投行金流與反洗錢 — 自學教材]] — 13 模組自學課程，前台實務（FX 語言/forward 利率差/swap 資金調度/Greeks 與 gamma hedging/Repo 生命週期/CCE-MPE 信用風險報表）× 洗錢五案（Wachovia 通匯／Danske 非居民／德銀鏡像交易／Troika 平行金融／太子集團與 Lazarus 鏈上）；每模組白話先行＋一手 PDF 頁碼導航＋自測題；含四判準、手冊×證物對讀法、中英詞彙表、Web3/CEX 面試映射；**每模組附「一手文件 × 精修版對照」三欄表（主題｜原件頁｜精修版章節），附錄 B 為三層導航（教材→精修版→原件 PDF）＋精修版進度表** `#教材 #AML #合規 #外匯 #選擇權 #repo #web3`
...
- [[Quant-Trading/雷曼Repo手冊-中文精修|雷曼 Repo 手冊 中文精修]] — 一手手冊全 71 頁十一節全覆蓋（教材 M5）：Repo 的雙重身分（經濟上擔保借貸／法律上賣出加買回，破產那天算哪一種取決於用哪張臉解讀）／六大用途牽動六部門／**生命週期十步且原件 62% 篇幅在講「成交之後」**／haircut＝借款人的股本，買的是價格緩衝＋清算時間＋流動性折價／Infinity 前台系統是狀態機且 Released 不可逆／CAMEO 盯市與 margin call 三個衝突期限／**末章接 Repo 105**；23 個實例區塊；**⚠️ 標出原件 16 處缺陷**（haircut 兩種口徑混用未定義、殘餘風險七項只涵蓋兩項半而缺的正是 wrong-way risk、matched book 實際刻意錯配天期、業績分誘因偏向冷門抵押品 30 倍、全書沒問「雷曼自己借不到錢會怎樣」、LBI/LBIE 法域區分僅靠 Excel 標色而三年後成為 Repo 105 的伏筆）`#教材 #中文精修 #Repo #附買回 #擔保品融資 #Repo105 #一手文件`
- [[Quant-Trading/雷曼信用風險報表手冊-中文精修|雷曼信用風險報表手冊 中文精修]] — 一手手冊全 32 頁（v1.0, CRMC review 2007-11-13）全章覆蓋（教材 M6）：CRR 團隊如何收集驗證彙總上報全行對手方曝險／開帳戶就是定義「誰是同一個風險」（EAM-GARM-CAS-CWS 四系統流程）／Agent-Principal 設錯的兩種災難／**CCE 告訴你今天要不要追繳擔保品、MPE 告訴你當初該不該讓他交易**（附同 CCE 不同 MPE 的八倍差距實例）／CRO dashboard 五分頁的 exception report 設計／Daily Excess 22 欄位／術語表中英對照；21 個實例區塊；**⚠️ 標出原件 9 處結構性問題**（Financing-FX-Forwards 對帳當時仍 work-in-progress、CVA 兩團隊算不同答案卻用 P&L 調整擺平、Daily Excess 把「提高額度」列在「中止交易」之前＝合規不能停業務的機制原始碼、Age 欄位有卻無升級 SLA、MPE 超限每週而名目每日、孤兒帳戶被動偵測、信用曝險與對外揭露系統性分歧、**自己被降評的擔保品試算只每月送 Treasury 而不在 CRO 日報**）；**⭐ 最重要發現：`Repo 105` 出現在這份 2007-11 手冊裡作為例行揭露差異項，比它成為調查核心早三年** `#教材 #中文精修 #信用風險 #CCE #MPE #風控報表 #一手文件`
- [[Quant-Trading/Examiner報告-Vol3-Repo105對讀|Examiner 報告 Vol 3 — Repo 105 對讀]] — 破產法院調查報告 336 頁的中文對讀（非手冊精修，是「規則 vs 實況」）：Repo 105/108 機制與 haircut 的會計目的／為何需要英國法律意見與 LBIE 的角色／**Examiner 認定的季末淨槓桿效果（2007Q4 16.1× vs 17.8×、2008Q1 15.4× vs 17.3×、2008Q2 12.1× vs 13.9×，單季約 1.7–1.9 個轉數）**／內部質疑與升級路徑／**22 組對讀表分零件-流程-控制三層**／CEX 對應的 12 條檢查清單；18 個實例區塊；**分寸嚴謹：Examiner 明言不觸及 SFAS 140 問題，「沒有認定違反」≠「認定符合」** `#教材 #中文對讀 #Repo105 #會計 #槓桿 #一手文件`
- [[Quant-Trading/Examiner報告-Vol1-風險治理對讀|Examiner 報告 Vol 1 — 風險治理對讀]] — 破產法院調查報告 Risk 章節（239 頁）的中文對讀：商業模式從 moving 到 storage 的轉變／風險限額體系與其實際下場／壓力測試排除清單（被排除部位佔尾部風險 79–81%）／早期警訊的傳遞與截斷／薪酬結構／Examiner 結論的分寸；16 實例、24 組對讀表、15 題自測；**⭐ 九問答覆表：逐一回答 CRR 手冊末章的 9 個查核問句（3 題有直接答案、4 題部分涵蓋、2 題明示 Vol 1 未涵蓋並指出該查哪卷）**；最強結論——超限的處理是調高限額 3 次／臨時豁免 ≥1 次／不執行整項限額 1 項／**降低風險 0 次**，且 2008-01 用回溯生效讓超限帳齡歸零 `#教材 #中文對讀 #風險治理 #限額管理 #一手文件`
- [[Quant-Trading/_教材審查報告-2026-07-30|教材審查報告（Fable 5）]] — 以「金融小白＋CEX 面試導向」為唯一標準的全套審查：11 項必修（含三處驗算實錯與四冊頁碼座標系統性混用）、應補、可省、學習路徑建議、面試準備缺口、21 列優先序表 `#審查 #教材品質`
